...
namespace vush {
    ...
    Error error_from_source(Allocator* const allocator, anton::String_View const source_path, i64 const line, i64 const column) {
    ...
    anton::String format_diagnostic_location(Allocator* const allocator, anton::String_View const source_path, i64 const line, i64 const column) {
        return anton::concat(allocator, source_path, u8":"_sv, anton::to_string(allocator, line), u8":"_sv, anton::to_string(allocator, column), u8": "_sv);
    }
    ...
    anton::String_View get_source_bit(anton::String_View const source, i64 const offset, i64 const end_offset) {
    ...
    void print_source_snippet(Context const& ctx, anton::String& out, anton::String_View const source, i64 const offset, i64 const end_offset, i64 const line) {
    ...
    void print_source_snippet(Context const& ctx, anton::String& out, anton::String_View const source, Source_Info const& src_info) {
