...
namespace vush {
    ...
    struct AST_Action {
        ...
        virtual void execute(Owning_Ptr<Identifier>& node);
        virtual void execute(Owning_Ptr<Builtin_Type>& node);
        virtual void execute(Owning_Ptr<User_Defined_Type>& node);
        virtual void execute(Owning_Ptr<Array_Type>& node);
        virtual void execute(Owning_Ptr<Declaration_If>& node);
        virtual void execute(Owning_Ptr<Import_Declaration>& node);
        virtual void execute(Owning_Ptr<Variable_Declaration>& node);
        virtual void execute(Owning_Ptr<Constant_Declaration>& node);
        virtual void execute(Owning_Ptr<Struct_Member>& node);
        virtual void execute(Owning_Ptr<Struct_Declaration>& node);
        virtual void execute(Owning_Ptr<Settings_Declaration>& node);
        virtual void execute(Owning_Ptr<Workgroup_Attribute>& node);
        virtual void execute(Owning_Ptr<Function_Param_If>& node);
        ...
        virtual void execute(Owning_Ptr<Assignment_Expression>& node);
        virtual void execute(Owning_Ptr<Arithmetic_Assignment_Expression>& node);
        virtual void execute(Owning_Ptr<Elvis_Expression>& node);
        virtual void execute(Owning_Ptr<Binary_Expression>& node);
        virtual void execute(Owning_Ptr<Unary_Expression>& node);
        virtual void execute(Owning_Ptr<Prefix_Increment_Expression>& node);
        virtual void execute(Owning_Ptr<Prefix_Decrement_Expression>& node);
        virtual void execute(Owning_Ptr<Function_Call_Expression>& node);
        virtual void execute(Owning_Ptr<Member_Access_Expression>& node);
        virtual void execute(Owning_Ptr<Array_Access_Expression>& node);
        virtual void execute(Owning_Ptr<Postfix_Increment_Expression>& node);
        virtual void execute(Owning_Ptr<Postfix_Decrement_Expression>& node);
        virtual void execute(Owning_Ptr<Parenthesised_Expression>& node);
        virtual void execute(Owning_Ptr<Reinterpret_Expression>& node);
        virtual void execute(Owning_Ptr<Default_Expression>& node);
        virtual void execute(Owning_Ptr<String_Literal>& node);
        virtual void execute(Owning_Ptr<Bool_Literal>& node);
        virtual void execute(Owning_Ptr<Integer_Literal>& node);
        virtual void execute(Owning_Ptr<Float_Literal>& node);
        virtual void execute(Owning_Ptr<Block_Statement>& node);
        virtual void execute(Owning_Ptr<If_Statement>& node);
        virtual void execute(Owning_Ptr<Case_Statement>& node);
        virtual void execute(Owning_Ptr<Switch_Statement>& node);
        virtual void execute(Owning_Ptr<For_Statement>& node);
        virtual void execute(Owning_Ptr<While_Statement>& node);
        virtual void execute(Owning_Ptr<Do_While_Statement>& node);
        virtual void execute(Owning_Ptr<Return_Statement>& node);
        virtual void execute(Owning_Ptr<Break_Statement>& node);
        virtual void execute(Owning_Ptr<Continue_Statement>& node);
        virtual void execute(Owning_Ptr<Discard_Statement>& node);
        virtual void execute(Owning_Ptr<Declaration_Statement>& node);
        virtual void execute(Owning_Ptr<Expression_Statement>& node);
    };
