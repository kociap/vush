...
namespace vush {
    struct Recursive_AST_Matcher {
        ...
        [[nodiscard]] virtual Match_Result match(Prefix_Expression const& node);
        ...
        [[nodiscard]] virtual Match_Result match(Postfix_Expression const& node);
    ...
    struct AST_Action {
        ...
        virtual Owning_Ptr<AST_Node> execute(Owning_Ptr<Prefix_Expression> node);
        ...
        virtual Owning_Ptr<AST_Node> execute(Owning_Ptr<Postfix_Expression> node);
