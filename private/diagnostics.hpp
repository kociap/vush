...
namespace vush {
    ...
    // TODO: Implement.
    [[nodiscard]] inline Error err_called_symbol_does_not_name_function([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& symbol) {
    ...
    // TODO: Implement.
    [[nodiscard]] inline Error err_immutable_variable_missing_initializer([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& constant) {
    ...
    // TODO: Implement.
    [[nodiscard]] inline Error err_duplicate_default_label([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& first,
                                                           [[maybe_unused]] Source_Info const& second) {
        return Error{.diagnostic = anton::String("err_duplicate_default_label")};
    }
    // TODO: Implement.
    [[nodiscard]] inline Error err_duplicate_label([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& first,
                                                   [[maybe_unused]] Source_Info const& second) {
        return Error{.diagnostic = anton::String("err_duplicate_label")};
    }
    // TODO: Implement.
    [[nodiscard]] inline Error err_invalid_switch_arm_expression([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& expression) {
        return Error{.diagnostic = anton::String("err_invalid_switch_arm_expression")};
    }

    [[nodiscard]] inline Error err_break_used_outside_loop([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& statement) {
        return Error{.diagnostic = anton::String("err_break_used_outside_loop")};
    }

    [[nodiscard]] inline Error err_continue_used_outside_loop([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& statement) {
    ...
    [[nodiscard]] inline Error err_identifier_names_a_function_but_is_not_called([[maybe_unused]] Context const& ctx,
    ...
    // TODO: Implement.
    [[nodiscard]] inline Error err_unsized_array_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& array) {
        return Error{.diagnostic = anton::String("err_unsized_array_not_allowed")};
    }
    [[nodiscard]] inline Error err_fn_sourced_parameter_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter) {
        return Error{.diagnostic = anton::String("err_fn_sourced_parameter_not_allowed")};
    }
    [[nodiscard]] inline Error err_stage_parameter_must_be_builtin_or_udt([[maybe_unused]] Context const& ctx,
    ...
    [[nodiscard]] inline Error err_vertex_ordinary_parameter_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter) {
        return Error{.diagnostic = anton::String("err_vertex_ordinary_parameter_not_allowed")};
    }
    [[nodiscard]] inline Error err_vertex_vin_must_not_be_opaque([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter_type) {
        return Error{.diagnostic = anton::String("err_vertex_vin_must_not_be_opaque")};
    }
    [[nodiscard]] inline Error err_vertex_vin_must_not_be_array([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter_type) {
        return Error{.diagnostic = anton::String("err_vertex_vin_must_not_be_array")};
    }
    [[nodiscard]] inline Error err_fragment_ordinary_parameter_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter) {
        return Error{.diagnostic = anton::String("err_fragment_ordinary_parameter_not_allowed")};
    }
    [[nodiscard]] inline Error err_fragment_vin_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter_source) {
        return Error{.diagnostic = anton::String("err_fragment_vin_not_allowed")};
    }
    [[nodiscard]] inline Error err_compute_ordinary_parameter_not_allowed([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter) {
        return Error{.diagnostic = anton::String("err_compute_ordinary_parameter_not_allowed")};
    }
    [[nodiscard]] inline Error err_compute_vin_not_allowed_on_stage([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& parameter) {
        return Error{.diagnostic = anton::String("err_compute_vin_not_allowed_on_stage")};
    }

    [[nodiscard]] inline Error err_ambiguous_overload([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Expr_Call const* call,
    ...
    [[nodiscard]] inline Error err_no_matching_overload([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Expr_Call const* call,
                                                        [[maybe_unused]] anton::Slice<ast::Decl_Function const* const> overloads) {
        return Error{.diagnostic = anton::String("err_no_matching_overload")};
    }

    [[nodiscard]] inline Error err_no_assignment_operator([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* from_type,
    ...
    [[nodiscard]] inline Error err_condition_not_of_bool_type([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Expr const* condition,
                                                              [[maybe_unused]] ast::Type const* condition_type) {
        return Error{.diagnostic = anton::String("err_condition_not_of_bool_type")};
    }

    [[nodiscard]] inline Error err_switch_expression_not_of_integer_type([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Expr const* expression,
    ...
    [[nodiscard]] inline Error err_incompatible_if_expression_types([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* then_type,
    ...
    [[nodiscard]] inline Error err_type_is_not_array([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* expr_type,
                                                     [[maybe_unused]] ast::Expr const* expr) {
        return Error{.diagnostic = anton::String("err_type_is_not_array")};
    }

    [[nodiscard]] inline Error err_array_index_is_not_integer([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* index_type,
                                                              [[maybe_unused]] ast::Expr const* index_expr) {
        return Error{.diagnostic = anton::String("err_array_index_is_not_integer")};
    }

    [[nodiscard]] inline Error err_type_has_no_member_named([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* type,
                                                            [[maybe_unused]] ast::Identifier const* member_identifier) {
        return Error{.diagnostic = anton::String("err_type_has_no_member_named")};
    }

    [[nodiscard]] inline Error err_init_type_is_builtin([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* type) {
        return Error{.diagnostic = anton::String("err_init_type_is_builtin")};
    }

    [[nodiscard]] inline Error err_init_invalid_struct_initializer_kind([[maybe_unused]] Context const& ctx,
    ...
    [[nodiscard]] inline Error err_init_invalid_array_initializer_kind([[maybe_unused]] Context const& ctx,
                                                                       [[maybe_unused]] ast::Initializer const* initializer) {
        return Error{.diagnostic = anton::String("err_init_invalid_array_initializer_kind")};
    }

    [[nodiscard]] inline Error err_init_array_initialization_must_not_have_both_initializer_kinds([[maybe_unused]] Context const& ctx,
                                                                                                  [[maybe_unused]] ast::Initializer const* first_initializer,
                                                                                                  [[maybe_unused]] ast::Initializer const* second_initializer) {
        return Error{.diagnostic = anton::String("err_init_array_initialization_must_not_have_both_initializer_kinds")};
    }

    [[nodiscard]] inline Error err_unimplemented([[maybe_unused]] Context const& ctx, [[maybe_unused]] Source_Info const& source) {
        return Error{.diagnostic = anton::String("err_unimplemented")};
    }

    [[nodiscard]] inline Error err_named_initializer_no_field_named([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Decl_Struct const* decl,
    ...
    [[nodiscard]] inline Error err_cannot_convert_type([[maybe_unused]] Context const& ctx, [[maybe_unused]] ast::Type const* to,
