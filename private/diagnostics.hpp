...
namespace vush {
    ...
    [[nodiscard]] anton::String format_stage_return_type_must_be_void_or_udt(Context const& ctx, anton::String_View pass_name, Stage_Kind stage,
                                                                             Type const& return_type);
    [[nodiscard]] anton::String format_stage_input_parameter_must_be_udt(Context const& ctx, anton::String_View pass_name, Stage_Kind stage,
