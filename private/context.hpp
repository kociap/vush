...
namespace vush {
  ...
  public:
    ...
    // Find the definition of a node. The definitions are populated by the defcheck pass and may be
    // one of the following: variable, parameter, overloaded function, struct declaration.
    //
