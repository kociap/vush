...
namespace vush {
  ...
  anton::Expected<bool, anton::String> is_compiletime_evaluable(Context& ctx,
  ...
  anton::Expected<Expr_Value, anton::String> evaluate_const_expr(Context& ctx,
                                                                 ast::Expr const& expression)
  {
    switch(expression.node_type) {
      // We currently do not handle floats, member access
      ...
      default: {
        return {anton::expected_error,
                err_expression_is_not_constant_evaluable(ctx, expression.source_info)
                  .format(ctx.allocator, ctx.diagnostics.extended)};
      }
      ...
      case AST_Node_Type::identifier_expression: {
        ...
        if(symbol->node_type != Symbol_Type::constant_declaration) {
          return {anton::expected_error, err_identifier_is_not_a_constant(ctx, expr.source_info)
                                           .format(ctx.allocator, ctx.diagnostics.extended)};
        }
      ...
      case AST_Node_Type::binary_expression: {
        ...
        switch(expr.type) {
          ...
          case Binary_Expression_Type::lor: {
            anton::Expected<Expr_Value, anton::String> lhs_res =
              evaluate_const_expr(ctx, *expr.lhs);
            if(!lhs_res) {
              return lhs_res;
            }
            ...
            if(!is_implicitly_convertible_to_boolean(lhs_res.value().type)) {
              ...
              return {anton::expected_error,
                      format_expression_not_implicitly_convertible_to_bool(ctx, src)};
            }

            anton::Expected<Expr_Value, anton::String> rhs_res =
              evaluate_const_expr(ctx, *expr.rhs);
            if(!rhs_res) {
              return rhs_res;
            }
          ...
          case Binary_Expression_Type::eq: {
            ...
            if(lhs.type != Expr_Value_Type::float64 && lhs.type != Expr_Value_Type::float32 &&
               lhs.type != Expr_Value_Type::uint32 && lhs.type != Expr_Value_Type::int32) {
              Source_Info const& src = expr.lhs->source_info;
              return {anton::expected_error,
                      build_error_message(src.source_path, src.line, src.column,
                                          u8"left-hand side of '==' is not of a scalar integer or "
                                          u8"a scalar floating-point type")};
            }

            if(rhs.type != Expr_Value_Type::float64 && rhs.type != Expr_Value_Type::float32 &&
               rhs.type != Expr_Value_Type::uint32 && rhs.type != Expr_Value_Type::int32) {
              Source_Info const& src = expr.rhs->source_info;
              return {anton::expected_error,
                      build_error_message(src.source_path, src.line, src.column,
                                          u8"right-hand side of '==' is not of a scalar integer or "
                                          u8"a scalar floating-point type")};
            }
            ...
            if(lhs.type == Expr_Value_Type::float64 || rhs.type == Expr_Value_Type::float64) {
              ...
              return {anton::expected_value, e};
            } else if(lhs.type == Expr_Value_Type::float32 ||
                      rhs.type == Expr_Value_Type::float32) {
          ...
          case Binary_Expression_Type::gt: {
            ...
            if(lhs.type != Expr_Value_Type::float64 && lhs.type != Expr_Value_Type::float32 &&
              ...
              return {anton::expected_error,
                      build_error_message(src.source_path, src.line, src.column,
                                          u8"left-hand side of '>' is not of a scalar integer or a "
                                          u8"scalar floating-point type")};
            }
      ...
      case AST_Node_Type::prefix_expression: {
        ...
        switch(expr.type) {
          ...
          case Prefix_Expression_Type::plus: {
            anton::Expected<Expr_Value, anton::String> base =
              evaluate_const_expr(ctx, *expr.expression);
            return base;
          }

          case Prefix_Expression_Type::minus: {
            anton::Expected<Expr_Value, anton::String> base_res =
              evaluate_const_expr(ctx, *expr.expression);
            if(!base_res) {
              return base_res;
            }
            ...
            if(base.type != Expr_Value_Type::float64 && base.type != Expr_Value_Type::float32 &&
               base.type != Expr_Value_Type::uint32 && base.type != Expr_Value_Type::int32) {
          ...
          case Prefix_Expression_Type::lnot: {
            ...
            Expr_Value base = base_res.value();
            if(base.type != Expr_Value_Type::boolean &&
               !is_implicitly_convertible_to_boolean(base.type)) {
              Source_Info const& src = expr.source_info;
              return {anton::expected_error,
                      build_error_message(src.source_path, src.line, src.column,
