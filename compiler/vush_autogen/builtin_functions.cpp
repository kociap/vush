  ...
  get_builtin_functions_declarations(Allocator* const allocator)
  {
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("inv_sqrt"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("inv_sqrt"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("inv_sqrt"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("round_even"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("round_even"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("round_even"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "outer_product"_sv);
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                          ALLOC_PARAM("r"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                          ALLOC_PARAM("r"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                          ALLOC_PARAM("r"_sv, &builtin_vec4))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat2x3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                          ALLOC_PARAM("r"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat3x2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                          ALLOC_PARAM("r"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat2x4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                          ALLOC_PARAM("r"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat4x2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                          ALLOC_PARAM("r"_sv, &builtin_vec4))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat3x4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                          ALLOC_PARAM("r"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("outer_product"_sv, &builtin_mat4x3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                          ALLOC_PARAM("r"_sv, &builtin_vec4))));
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "less_than"_sv);
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than"_sv, &builtin_bvec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                          ALLOC_PARAM("y"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than"_sv, &builtin_bvec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                          ALLOC_PARAM("y"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than"_sv, &builtin_bvec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                          ALLOC_PARAM("y"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "less_than_equal"_sv);
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than_equal"_sv, &builtin_bvec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                          ALLOC_PARAM("y"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than_equal"_sv, &builtin_bvec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                          ALLOC_PARAM("y"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("less_than_equal"_sv, &builtin_bvec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                          ALLOC_PARAM("y"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "greater_than"_sv);
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than"_sv, &builtin_bvec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                          ALLOC_PARAM("y"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than"_sv, &builtin_bvec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                          ALLOC_PARAM("y"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than"_sv, &builtin_bvec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                          ALLOC_PARAM("y"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      ...
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than_equal"_sv, &builtin_bvec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                          ALLOC_PARAM("y"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than_equal"_sv, &builtin_bvec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                          ALLOC_PARAM("y"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("greater_than_equal"_sv, &builtin_bvec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                          ALLOC_PARAM("y"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "not_equal"_sv);
      g->overloads.push_back(
        ALLOC_FUNCTION("not_equal"_sv, &builtin_bvec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                          ALLOC_PARAM("y"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("not_equal"_sv, &builtin_bvec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                          ALLOC_PARAM("y"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("not_equal"_sv, &builtin_bvec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                          ALLOC_PARAM("y"_sv, &builtin_vec4))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_query_levels"_sv, &builtin_int,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D))));
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_query_levels"_sv, &builtin_int,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D))));
    ...
    }
    {
      auto g = VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator,
                             "texture_samples"_sv);
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_samples"_sv, &builtin_int,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DMS))));
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_samples"_sv, &builtin_int,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DMS))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                           ...
                           ALLOC_PARAM("lod"_sv, &builtin_float))));
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_proj_lod"_sv, &builtin_float,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                           ALLOC_PARAM("P"_sv, &builtin_vec4),
                           ALLOC_PARAM("lod"_sv, &builtin_float))));
      g->overloads.push_back(ALLOC_FUNCTION(
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                           ...
                           ALLOC_PARAM("offset"_sv, &builtin_ivec3))));
      g->overloads.push_back(ALLOC_FUNCTION(
        "texture_proj_lod_offset"_sv, &builtin_float,
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                           ALLOC_PARAM("P"_sv, &builtin_vec4),
                           ALLOC_PARAM("lod"_sv, &builtin_float),
                           ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_fine"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_fine"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_fine"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_fine"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_fine"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_fine"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_coarse"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_coarse"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdx_coarse"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_coarse"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_coarse"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("dFdy_coarse"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_fine"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_fine"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_fine"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        ...
        *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_coarse"_sv, &builtin_vec2,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_coarse"_sv, &builtin_vec3,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
      g->overloads.push_back(
        ALLOC_FUNCTION("fwidth_coarse"_sv, &builtin_vec4,
                       *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        "memory_barrier_buffer"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        "memory_barrier_shared"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        "memory_barrier_image"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    }
    {
      ...
      g->overloads.push_back(ALLOC_FUNCTION(
        "group_memory_barrier"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
