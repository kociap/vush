...
namespace vush {
  ...
  get_builtin_functions_declarations(Allocator* const allocator)
  {
    ...
    group_0->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pdegrees"_sv, &builtin_float))));
    group_0->overloads.push_back(ALLOC_FUNCTION(
      "radians"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pdegrees"_sv, &builtin_vec2))));
    group_0->overloads.push_back(ALLOC_FUNCTION(
      "radians"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pdegrees"_sv, &builtin_vec3))));
    group_0->overloads.push_back(ALLOC_FUNCTION(
      "radians"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pdegrees"_sv, &builtin_vec4))));
    ...
    group_1->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pradians"_sv, &builtin_float))));
    group_1->overloads.push_back(ALLOC_FUNCTION(
      "degrees"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pradians"_sv, &builtin_vec2))));
    group_1->overloads.push_back(ALLOC_FUNCTION(
      "degrees"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pradians"_sv, &builtin_vec3))));
    group_1->overloads.push_back(ALLOC_FUNCTION(
      "degrees"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("pradians"_sv, &builtin_vec4))));
    ...
    group_2->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("angle"_sv, &builtin_float))));
    group_2->overloads.push_back(ALLOC_FUNCTION(
      "sin"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("angle"_sv, &builtin_vec2))));
    group_2->overloads.push_back(ALLOC_FUNCTION(
      "sin"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("angle"_sv, &builtin_vec3))));
    group_2->overloads.push_back(ALLOC_FUNCTION(
      "sin"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("angle"_sv, &builtin_vec4))));
    ...
    group_5->overloads.push_back(
      ALLOC_FUNCTION("asin"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_5->overloads.push_back(
      ALLOC_FUNCTION("asin"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_5->overloads.push_back(
      ALLOC_FUNCTION("asin"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_5->overloads.push_back(
      ALLOC_FUNCTION("asin"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("asin"_sv, group_5);
    auto group_6 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "acos"_sv);
    group_6->overloads.push_back(
      ALLOC_FUNCTION("acos"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_6->overloads.push_back(
      ALLOC_FUNCTION("acos"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_6->overloads.push_back(
      ALLOC_FUNCTION("acos"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_6->overloads.push_back(
      ALLOC_FUNCTION("acos"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("acos"_sv, group_6);
    auto group_7 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "atan"_sv);
    group_7->overloads.push_back(
      ALLOC_FUNCTION("atan"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y"_sv, &builtin_float),
                                        ALLOC_PARAM("x"_sv, &builtin_float))));
    group_7->overloads.push_back(
      ALLOC_FUNCTION("atan"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y"_sv, &builtin_vec2),
                                        ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_7->overloads.push_back(
      ALLOC_FUNCTION("atan"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y"_sv, &builtin_vec3),
                                        ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_7->overloads.push_back(
      ALLOC_FUNCTION("atan"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y"_sv, &builtin_vec4),
                                        ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_7->overloads.push_back(ALLOC_FUNCTION(
      "atan"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y_over_x"_sv, &builtin_float))));
    group_7->overloads.push_back(ALLOC_FUNCTION(
      "atan"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y_over_x"_sv, &builtin_vec2))));
    group_7->overloads.push_back(ALLOC_FUNCTION(
      "atan"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y_over_x"_sv, &builtin_vec3))));
    group_7->overloads.push_back(ALLOC_FUNCTION(
      "atan"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("y_over_x"_sv, &builtin_vec4))));
    groups.emplace("atan"_sv, group_7);
    auto group_8 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "sinh"_sv);
    group_8->overloads.push_back(
      ALLOC_FUNCTION("sinh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_8->overloads.push_back(
      ALLOC_FUNCTION("sinh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_8->overloads.push_back(
      ALLOC_FUNCTION("sinh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_8->overloads.push_back(
      ALLOC_FUNCTION("sinh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("sinh"_sv, group_8);
    auto group_9 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "cosh"_sv);
    group_9->overloads.push_back(
      ALLOC_FUNCTION("cosh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_9->overloads.push_back(
      ALLOC_FUNCTION("cosh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_9->overloads.push_back(
      ALLOC_FUNCTION("cosh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_9->overloads.push_back(
      ALLOC_FUNCTION("cosh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("cosh"_sv, group_9);
    auto group_10 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "tanh"_sv);
    group_10->overloads.push_back(
      ALLOC_FUNCTION("tanh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_10->overloads.push_back(
      ALLOC_FUNCTION("tanh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_10->overloads.push_back(
      ALLOC_FUNCTION("tanh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_10->overloads.push_back(
      ALLOC_FUNCTION("tanh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_11->overloads.push_back(
      ALLOC_FUNCTION("asinh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_11->overloads.push_back(
      ALLOC_FUNCTION("asinh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_11->overloads.push_back(
      ALLOC_FUNCTION("asinh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_11->overloads.push_back(
      ALLOC_FUNCTION("asinh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_12->overloads.push_back(
      ALLOC_FUNCTION("acosh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_12->overloads.push_back(
      ALLOC_FUNCTION("acosh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_12->overloads.push_back(
      ALLOC_FUNCTION("acosh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_12->overloads.push_back(
      ALLOC_FUNCTION("acosh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_13->overloads.push_back(
      ALLOC_FUNCTION("atanh"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_13->overloads.push_back(
      ALLOC_FUNCTION("atanh"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_13->overloads.push_back(
      ALLOC_FUNCTION("atanh"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_13->overloads.push_back(
      ALLOC_FUNCTION("atanh"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_14->overloads.push_back(
      ALLOC_FUNCTION("pow"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_14->overloads.push_back(
      ALLOC_FUNCTION("pow"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_14->overloads.push_back(
      ALLOC_FUNCTION("pow"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_14->overloads.push_back(
      ALLOC_FUNCTION("pow"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
    ...
    group_15->overloads.push_back(
      ALLOC_FUNCTION("exp"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_15->overloads.push_back(
      ALLOC_FUNCTION("exp"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_15->overloads.push_back(
      ALLOC_FUNCTION("exp"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_15->overloads.push_back(
      ALLOC_FUNCTION("exp"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("exp"_sv, group_15);
    auto group_16 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "log"_sv);
    group_16->overloads.push_back(
      ALLOC_FUNCTION("log"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_16->overloads.push_back(
      ALLOC_FUNCTION("log"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_16->overloads.push_back(
      ALLOC_FUNCTION("log"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_16->overloads.push_back(
      ALLOC_FUNCTION("log"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    groups.emplace("log"_sv, group_16);
    auto group_17 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "exp2"_sv);
    group_17->overloads.push_back(
      ALLOC_FUNCTION("exp2"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_17->overloads.push_back(
      ALLOC_FUNCTION("exp2"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_17->overloads.push_back(
      ALLOC_FUNCTION("exp2"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_17->overloads.push_back(
      ALLOC_FUNCTION("exp2"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_18->overloads.push_back(
      ALLOC_FUNCTION("log2"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_18->overloads.push_back(
      ALLOC_FUNCTION("log2"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_18->overloads.push_back(
      ALLOC_FUNCTION("log2"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_18->overloads.push_back(
      ALLOC_FUNCTION("log2"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    ...
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_19->overloads.push_back(
      ALLOC_FUNCTION("sqrt"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_20->overloads.push_back(
      ALLOC_FUNCTION("inversesqrt"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_int))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec2))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec3))));
    group_21->overloads.push_back(
      ALLOC_FUNCTION("abs"_sv, &builtin_ivec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec4))));
    groups.emplace("abs"_sv, group_21);
    auto group_22 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "sign"_sv);
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_int))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec2))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec3))));
    group_22->overloads.push_back(
      ALLOC_FUNCTION("sign"_sv, &builtin_ivec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec4))));
    ...
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_23->overloads.push_back(
      ALLOC_FUNCTION("floor"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_24->overloads.push_back(
      ALLOC_FUNCTION("trunc"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_25->overloads.push_back(
      ALLOC_FUNCTION("round"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_26->overloads.push_back(
      ALLOC_FUNCTION("roundEven"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_27->overloads.push_back(
      ALLOC_FUNCTION("ceil"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_28->overloads.push_back(
      ALLOC_FUNCTION("fract"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_29->overloads.push_back(
      ALLOC_FUNCTION("mod"_sv, &builtin_vec2,
    ...
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_dvec2))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_dvec3))));
    group_30->overloads.push_back(
      ALLOC_FUNCTION("modf"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_dvec4))));
    ...
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_int),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec2),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec3),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_ivec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec4),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uint),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_uvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_uvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_uvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_31->overloads.push_back(
      ALLOC_FUNCTION("min"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
    ...
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_int),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec2),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec3),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_ivec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_ivec4),
                                        ALLOC_PARAM("y"_sv, &builtin_int))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uint),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_uvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec2),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_uvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_uvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec4),
                                        ALLOC_PARAM("y"_sv, &builtin_uint))));
    group_32->overloads.push_back(
      ALLOC_FUNCTION("max"_sv, &builtin_vec2,
    ...
    group_34->overloads.push_back(
      ALLOC_FUNCTION("packUnorm2x16"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_vec2))));
    ...
    group_35->overloads.push_back(
      ALLOC_FUNCTION("packSnorm2x16"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_vec2))));
    ...
    group_36->overloads.push_back(
      ALLOC_FUNCTION("packUnorm4x8"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_vec4))));
    ...
    group_37->overloads.push_back(
      ALLOC_FUNCTION("packSnorm4x8"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_vec4))));
    ...
    group_38->overloads.push_back(
      ALLOC_FUNCTION("unpackUnorm2x16"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_uint))));
    ...
    group_39->overloads.push_back(
      ALLOC_FUNCTION("unpackSnorm2x16"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_uint))));
    ...
    group_40->overloads.push_back(
      ALLOC_FUNCTION("unpackUnorm4x8"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_uint))));
    ...
    group_41->overloads.push_back(
      ALLOC_FUNCTION("unpackSnorm4x8"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_uint))));
    ...
    group_42->overloads.push_back(
      ALLOC_FUNCTION("packHalf2x16"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_vec2))));
    ...
    group_43->overloads.push_back(
      ALLOC_FUNCTION("unpackHalf2x16"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_uint))));
    ...
    group_44->overloads.push_back(
      ALLOC_FUNCTION("packDouble2x32"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_uvec2))));
    ...
    group_45->overloads.push_back(
      ALLOC_FUNCTION("unpackDouble2x32"_sv, &builtin_uvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("v"_sv, &builtin_double))));
    ...
    group_46->overloads.push_back(
      ALLOC_FUNCTION("length"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_46->overloads.push_back(
      ALLOC_FUNCTION("length"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    ...
    group_46->overloads.push_back(
      ALLOC_FUNCTION("length"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_46->overloads.push_back(
      ALLOC_FUNCTION("length"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_46->overloads.push_back(
      ALLOC_FUNCTION("length"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    ...
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_float),
                                        ALLOC_PARAM("p1"_sv, &builtin_float))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_vec2),
                                        ALLOC_PARAM("p1"_sv, &builtin_vec2))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_vec3),
                                        ALLOC_PARAM("p1"_sv, &builtin_vec3))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_vec4),
                                        ALLOC_PARAM("p1"_sv, &builtin_vec4))));
    group_47->overloads.push_back(ALLOC_FUNCTION(
      "distance"_sv, &builtin_double,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_double),
                         ALLOC_PARAM("p1"_sv, &builtin_double))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("p1"_sv, &builtin_dvec2))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("p1"_sv, &builtin_dvec3))));
    group_47->overloads.push_back(
      ALLOC_FUNCTION("distance"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p0"_sv, &builtin_dvec4),
    ...
    group_48->overloads.push_back(
      ALLOC_FUNCTION("dot"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float),
                                        ALLOC_PARAM("y"_sv, &builtin_float))));
    group_48->overloads.push_back(
      ALLOC_FUNCTION("dot"_sv, &builtin_float,
    ...
    group_48->overloads.push_back(
      ALLOC_FUNCTION("dot"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_48->overloads.push_back(
      ALLOC_FUNCTION("dot"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double),
                                        ALLOC_PARAM("y"_sv, &builtin_double))));
    group_48->overloads.push_back(
      ALLOC_FUNCTION("dot"_sv, &builtin_double,
    ...
    group_49->overloads.push_back(
      ALLOC_FUNCTION("cross"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_49->overloads.push_back(
      ALLOC_FUNCTION("cross"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("y"_sv, &builtin_dvec3))));
    ...
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_float))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_double))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec2))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec3))));
    group_50->overloads.push_back(
      ALLOC_FUNCTION("normalize"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_dvec4))));
    ...
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_float),
                                        ALLOC_PARAM("N"_sv, &builtin_float))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec2),
                                        ALLOC_PARAM("N"_sv, &builtin_vec2))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec3),
                                        ALLOC_PARAM("N"_sv, &builtin_vec3))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec4),
                                        ALLOC_PARAM("N"_sv, &builtin_vec4))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_double,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_double),
                                        ALLOC_PARAM("N"_sv, &builtin_double))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_dvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec2),
                                        ALLOC_PARAM("N"_sv, &builtin_dvec2))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_dvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec3),
                                        ALLOC_PARAM("N"_sv, &builtin_dvec3))));
    group_52->overloads.push_back(
      ALLOC_FUNCTION("reflect"_sv, &builtin_dvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec4),
    ...
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_float),
                         ALLOC_PARAM("N"_sv, &builtin_float),
                         ALLOC_PARAM("eta"_sv, &builtin_float))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec2),
                         ALLOC_PARAM("N"_sv, &builtin_vec2),
                         ALLOC_PARAM("eta"_sv, &builtin_float))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec3),
                         ALLOC_PARAM("N"_sv, &builtin_vec3),
                         ALLOC_PARAM("eta"_sv, &builtin_float))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_vec4),
                         ALLOC_PARAM("N"_sv, &builtin_vec4),
                         ALLOC_PARAM("eta"_sv, &builtin_float))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_double,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_double),
                         ALLOC_PARAM("N"_sv, &builtin_double),
                         ALLOC_PARAM("eta"_sv, &builtin_double))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_dvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec2),
                         ALLOC_PARAM("N"_sv, &builtin_dvec2),
                         ALLOC_PARAM("eta"_sv, &builtin_double))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_dvec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec3),
                         ALLOC_PARAM("N"_sv, &builtin_dvec3),
                         ALLOC_PARAM("eta"_sv, &builtin_double))));
    group_53->overloads.push_back(ALLOC_FUNCTION(
      "refract"_sv, &builtin_dvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("I"_sv, &builtin_dvec4),
                         ALLOC_PARAM("N"_sv, &builtin_dvec4),
                         ALLOC_PARAM("eta"_sv, &builtin_double))));
    ...
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat2),
                                        ALLOC_PARAM("y"_sv, &builtin_mat2))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat3),
                                        ALLOC_PARAM("y"_sv, &builtin_mat3))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat4),
                                        ALLOC_PARAM("y"_sv, &builtin_mat4))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat2x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat2x3),
                                        ALLOC_PARAM("y"_sv, &builtin_mat2x3))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat2x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat2x4),
                                        ALLOC_PARAM("y"_sv, &builtin_mat2x4))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat3x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat3x2),
                                        ALLOC_PARAM("y"_sv, &builtin_mat3x2))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat3x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat3x4),
                                        ALLOC_PARAM("y"_sv, &builtin_mat3x4))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat4x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat4x2),
                                        ALLOC_PARAM("y"_sv, &builtin_mat4x2))));
    group_54->overloads.push_back(
      ALLOC_FUNCTION("matrixCompMult"_sv, &builtin_mat4x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_mat4x3),
    ...
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                        ALLOC_PARAM("r"_sv, &builtin_vec2))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                        ALLOC_PARAM("r"_sv, &builtin_vec3))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                        ALLOC_PARAM("r"_sv, &builtin_vec4))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat2x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                        ALLOC_PARAM("r"_sv, &builtin_vec2))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat3x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                        ALLOC_PARAM("r"_sv, &builtin_vec3))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat2x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                        ALLOC_PARAM("r"_sv, &builtin_vec2))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat4x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec2),
                                        ALLOC_PARAM("r"_sv, &builtin_vec4))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat3x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec4),
                                        ALLOC_PARAM("r"_sv, &builtin_vec3))));
    group_55->overloads.push_back(
      ALLOC_FUNCTION("outerProduct"_sv, &builtin_mat4x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("c"_sv, &builtin_vec3),
                                        ALLOC_PARAM("r"_sv, &builtin_vec4))));
    ...
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat2))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat3))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat4))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat2x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat3x2))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat3x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat2x3))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat2x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat4x2))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat4x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat2x4))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat3x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat4x3))));
    group_56->overloads.push_back(
      ALLOC_FUNCTION("transpose"_sv, &builtin_mat4x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat3x4))));
    ...
    group_57->overloads.push_back(
      ALLOC_FUNCTION("determinant"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat2))));
    group_57->overloads.push_back(
      ALLOC_FUNCTION("determinant"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat3))));
    ...
    group_58->overloads.push_back(
      ALLOC_FUNCTION("inverse"_sv, &builtin_mat2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat2))));
    group_58->overloads.push_back(
      ALLOC_FUNCTION("inverse"_sv, &builtin_mat3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat3))));
    group_58->overloads.push_back(
      ALLOC_FUNCTION("inverse"_sv, &builtin_mat4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("m"_sv, &builtin_mat4))));
    ...
    group_59->overloads.push_back(
      ALLOC_FUNCTION("lessThan"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_59->overloads.push_back(
      ALLOC_FUNCTION("lessThan"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_59->overloads.push_back(
      ALLOC_FUNCTION("lessThan"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_59->overloads.push_back(
      ALLOC_FUNCTION("lessThan"_sv, &builtin_bvec2,
    ...
    group_60->overloads.push_back(
      ALLOC_FUNCTION("lessThanEqual"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_60->overloads.push_back(
      ALLOC_FUNCTION("lessThanEqual"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_60->overloads.push_back(
      ALLOC_FUNCTION("lessThanEqual"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_60->overloads.push_back(
      ALLOC_FUNCTION("lessThanEqual"_sv, &builtin_bvec2,
    ...
    group_61->overloads.push_back(
      ALLOC_FUNCTION("greaterThan"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_61->overloads.push_back(
      ALLOC_FUNCTION("greaterThan"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_61->overloads.push_back(
      ALLOC_FUNCTION("greaterThan"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_61->overloads.push_back(
      ALLOC_FUNCTION("greaterThan"_sv, &builtin_bvec2,
    ...
    group_62->overloads.push_back(
      ALLOC_FUNCTION("greaterThanEqual"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_62->overloads.push_back(
      ALLOC_FUNCTION("greaterThanEqual"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_62->overloads.push_back(
      ALLOC_FUNCTION("greaterThanEqual"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_62->overloads.push_back(
      ALLOC_FUNCTION("greaterThanEqual"_sv, &builtin_bvec2,
    ...
    group_63->overloads.push_back(
      ALLOC_FUNCTION("equal"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_63->overloads.push_back(
      ALLOC_FUNCTION("equal"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_63->overloads.push_back(
      ALLOC_FUNCTION("equal"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_63->overloads.push_back(
      ALLOC_FUNCTION("equal"_sv, &builtin_bvec2,
    ...
    group_64->overloads.push_back(
      ALLOC_FUNCTION("notEqual"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec2),
                                        ALLOC_PARAM("y"_sv, &builtin_vec2))));
    group_64->overloads.push_back(
      ALLOC_FUNCTION("notEqual"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec3),
                                        ALLOC_PARAM("y"_sv, &builtin_vec3))));
    group_64->overloads.push_back(
      ALLOC_FUNCTION("notEqual"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_vec4),
                                        ALLOC_PARAM("y"_sv, &builtin_vec4))));
    group_64->overloads.push_back(
      ALLOC_FUNCTION("notEqual"_sv, &builtin_bvec2,
    ...
    group_65->overloads.push_back(
      ALLOC_FUNCTION("any"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec2))));
    group_65->overloads.push_back(
      ALLOC_FUNCTION("any"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec3))));
    group_65->overloads.push_back(
      ALLOC_FUNCTION("any"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec4))));
    groups.emplace("any"_sv, group_65);
    auto group_66 =
      VUSH_ALLOCATE(ast::Overload_Group, allocator, allocator, "all"_sv);
    group_66->overloads.push_back(
      ALLOC_FUNCTION("all"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec2))));
    group_66->overloads.push_back(
      ALLOC_FUNCTION("all"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec3))));
    ...
    group_67->overloads.push_back(
      ALLOC_FUNCTION("not"_sv, &builtin_bvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec2))));
    group_67->overloads.push_back(
      ALLOC_FUNCTION("not"_sv, &builtin_bvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec3))));
    group_67->overloads.push_back(
      ALLOC_FUNCTION("not"_sv, &builtin_bvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_bvec4))));
    ...
    group_68->overloads.push_back(ALLOC_FUNCTION(
      "uaddCarry"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uint),
                         ALLOC_PARAM("y"_sv, &builtin_uint),
                         ALLOC_PARAM("carry"_sv, &builtin_uint))));
    group_68->overloads.push_back(ALLOC_FUNCTION(
      "uaddCarry"_sv, &builtin_uvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec2),
                         ALLOC_PARAM("y"_sv, &builtin_uvec2),
                         ALLOC_PARAM("carry"_sv, &builtin_uvec2))));
    group_68->overloads.push_back(ALLOC_FUNCTION(
      "uaddCarry"_sv, &builtin_uvec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec3),
                         ALLOC_PARAM("y"_sv, &builtin_uvec3),
                         ALLOC_PARAM("carry"_sv, &builtin_uvec3))));
    group_68->overloads.push_back(ALLOC_FUNCTION(
      "uaddCarry"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec4),
                         ALLOC_PARAM("y"_sv, &builtin_uvec4),
    ...
    group_69->overloads.push_back(ALLOC_FUNCTION(
      "usubBorrow"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uint),
                         ALLOC_PARAM("y"_sv, &builtin_uint),
                         ALLOC_PARAM("borrow"_sv, &builtin_uint))));
    group_69->overloads.push_back(ALLOC_FUNCTION(
      "usubBorrow"_sv, &builtin_uvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec2),
                         ALLOC_PARAM("y"_sv, &builtin_uvec2),
                         ALLOC_PARAM("borrow"_sv, &builtin_uvec2))));
    group_69->overloads.push_back(ALLOC_FUNCTION(
      "usubBorrow"_sv, &builtin_uvec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec3),
                         ALLOC_PARAM("y"_sv, &builtin_uvec3),
                         ALLOC_PARAM("borrow"_sv, &builtin_uvec3))));
    group_69->overloads.push_back(ALLOC_FUNCTION(
      "usubBorrow"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("x"_sv, &builtin_uvec4),
                         ALLOC_PARAM("y"_sv, &builtin_uvec4),
    ...
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_int),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_ivec2),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_ivec3),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_ivec4),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_uint),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_uvec2),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_uvec3),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_72->overloads.push_back(
      ALLOC_FUNCTION("bitfieldExtract"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_uvec4),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    ...
    group_73->overloads.push_back(
      ALLOC_FUNCTION("bitfieldInsert"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_int),
                                        ALLOC_PARAM("insert"_sv, &builtin_int),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec2),
                         ALLOC_PARAM("insert"_sv, &builtin_ivec2),
                         ALLOC_PARAM("offset"_sv, &builtin_int),
                         ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec3),
                         ALLOC_PARAM("insert"_sv, &builtin_ivec3),
                         ALLOC_PARAM("offset"_sv, &builtin_int),
                         ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec4),
                         ALLOC_PARAM("insert"_sv, &builtin_ivec4),
                         ALLOC_PARAM("offset"_sv, &builtin_int),
                         ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(
      ALLOC_FUNCTION("bitfieldInsert"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_uint),
                                        ALLOC_PARAM("insert"_sv, &builtin_uint),
                                        ALLOC_PARAM("offset"_sv, &builtin_int),
                                        ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_uvec2),
                         ALLOC_PARAM("insert"_sv, &builtin_uvec2),
                         ALLOC_PARAM("offset"_sv, &builtin_int),
                         ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_uvec3),
                         ALLOC_PARAM("insert"_sv, &builtin_uvec3),
                         ALLOC_PARAM("offset"_sv, &builtin_int),
                         ALLOC_PARAM("bits"_sv, &builtin_int))));
    group_73->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldInsert"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_uvec4),
    ...
    group_74->overloads.push_back(
      ALLOC_FUNCTION("bitfieldReverse"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_int))));
    group_74->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldReverse"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec2))));
    group_74->overloads.push_back(ALLOC_FUNCTION(
      "bitfieldReverse"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec3))));
    ...
    group_75->overloads.push_back(
      ALLOC_FUNCTION("bitCount"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_int))));
    group_75->overloads.push_back(ALLOC_FUNCTION(
      "bitCount"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec2))));
    group_75->overloads.push_back(ALLOC_FUNCTION(
      "bitCount"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec3))));
    ...
    group_76->overloads.push_back(
      ALLOC_FUNCTION("findLSB"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_int))));
    group_76->overloads.push_back(ALLOC_FUNCTION(
      "findLSB"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec2))));
    group_76->overloads.push_back(ALLOC_FUNCTION(
      "findLSB"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec3))));
    ...
    group_77->overloads.push_back(
      ALLOC_FUNCTION("findMSB"_sv, &builtin_void,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_int))));
    group_77->overloads.push_back(ALLOC_FUNCTION(
      "findMSB"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec2))));
    group_77->overloads.push_back(ALLOC_FUNCTION(
      "findMSB"_sv, &builtin_void,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("base"_sv, &builtin_ivec3))));
    ...
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler3D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler3D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_samplerCube),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isamplerCube),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usamplerCube),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DShadow),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_samplerCubeShadow),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_samplerCubeArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isamplerCubeArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usamplerCubeArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(
    ...
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(
      ALLOC_FUNCTION("textureSize"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArrayShadow),
                       ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2DArray),
                         ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(
      ALLOC_FUNCTION("textureSize"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DArrayShadow),
                       ALLOC_PARAM("lod"_sv, &builtin_int))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRect))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DRect))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2DRect))));
    group_78->overloads.push_back(
      ALLOC_FUNCTION("textureSize"_sv, &builtin_ivec2,
    ...
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_samplerBuffer))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isamplerBuffer))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usamplerBuffer))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DMS))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DMS))));
    group_78->overloads.push_back(ALLOC_FUNCTION(
      "textureSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2DMS))));
    group_78->overloads.push_back(
      ALLOC_FUNCTION("textureSize"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(
    ...
    group_79->overloads.push_back(ALLOC_FUNCTION(
      "textureQueryLod"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
    ...
    group_79->overloads.push_back(
      ALLOC_FUNCTION("textureQueryLod"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_float))));
    group_79->overloads.push_back(
    ...
    group_80->overloads.push_back(ALLOC_FUNCTION(
      "textureQueryLevels"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D))));
    group_80->overloads.push_back(ALLOC_FUNCTION(
      "textureQueryLevels"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D))));
    ...
    group_80->overloads.push_back(
      ALLOC_FUNCTION("textureQueryLevels"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(
    ...
    group_81->overloads.push_back(ALLOC_FUNCTION(
      "textureSamples"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DMS))));
    group_81->overloads.push_back(ALLOC_FUNCTION(
      "textureSamples"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DMS))));
    ...
    group_81->overloads.push_back(
      ALLOC_FUNCTION("textureSamples"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DMSArray))));
    group_81->overloads.push_back(
      ALLOC_FUNCTION("textureSamples"_sv, &builtin_int,
    ...
    group_83->overloads.push_back(ALLOC_FUNCTION(
      "textureProj"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_83->overloads.push_back(ALLOC_FUNCTION(
      "textureProj"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_83->overloads.push_back(ALLOC_FUNCTION(
      "textureProj"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_83->overloads.push_back(ALLOC_FUNCTION(
      "textureProj"_sv, &builtin_vec4,
    ...
    group_83->overloads.push_back(
      ALLOC_FUNCTION("textureProj"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec4))));
    ...
    group_84->overloads.push_back(ALLOC_FUNCTION(
      "textureLod"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_84->overloads.push_back(ALLOC_FUNCTION(
      "textureLod"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_84->overloads.push_back(ALLOC_FUNCTION(
      "textureLod"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_84->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_84->overloads.push_back(
      ALLOC_FUNCTION("textureLod"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("lod"_sv, &builtin_float))));
    ...
    group_85->overloads.push_back(ALLOC_FUNCTION(
      "textureOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_85->overloads.push_back(ALLOC_FUNCTION(
      "textureOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_85->overloads.push_back(ALLOC_FUNCTION(
      "textureOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_85->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_85->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ...
                         ALLOC_PARAM("bias"_sv, &builtin_float))));
    group_85->overloads.push_back(ALLOC_FUNCTION(
      "textureOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec3),
                         ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_85->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_85->overloads.push_back(
      ALLOC_FUNCTION("textureOffset"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int))));
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int))));
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int))));
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_vec4,
    ...
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2DMSArray),
                         ALLOC_PARAM("P"_sv, &builtin_ivec3),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2DMSArray),
                         ALLOC_PARAM("P"_sv, &builtin_ivec3),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_86->overloads.push_back(ALLOC_FUNCTION(
      "texelFetch"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2DMSArray),
                         ALLOC_PARAM("P"_sv, &builtin_ivec3),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    ...
    group_87->overloads.push_back(ALLOC_FUNCTION(
      "texelFetchOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int),
                         ALLOC_PARAM("lod"_sv, &builtin_int),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_87->overloads.push_back(ALLOC_FUNCTION(
      "texelFetchOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int),
                         ALLOC_PARAM("lod"_sv, &builtin_int),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_87->overloads.push_back(ALLOC_FUNCTION(
      "texelFetchOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_int),
                         ALLOC_PARAM("lod"_sv, &builtin_int),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_88->overloads.push_back(ALLOC_FUNCTION(
      "textureProjOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_88->overloads.push_back(ALLOC_FUNCTION(
      "textureProjOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_88->overloads.push_back(ALLOC_FUNCTION(
      "textureProjOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_88->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_88->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ...
                         ALLOC_PARAM("bias"_sv, &builtin_float))));
    group_88->overloads.push_back(ALLOC_FUNCTION(
      "textureProjOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec4),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_88->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_88->overloads.push_back(
      ALLOC_FUNCTION("textureProjOffset"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec4),
                       ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    ...
    group_89->overloads.push_back(ALLOC_FUNCTION(
      "textureLodOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_89->overloads.push_back(ALLOC_FUNCTION(
      "textureLodOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_89->overloads.push_back(ALLOC_FUNCTION(
      "textureLodOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_89->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ...
                         ALLOC_PARAM("offset"_sv, &builtin_ivec3))));
    group_89->overloads.push_back(ALLOC_FUNCTION(
      "textureLodOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec3),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_89->overloads.push_back(
      ALLOC_FUNCTION("textureLodOffset"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler1DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("lod"_sv, &builtin_float),
    ...
    group_90->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLod"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_90->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLod"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_90->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLod"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_90->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_90->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ...
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_90->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLod"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec4),
                         ALLOC_PARAM("lod"_sv, &builtin_float))));
    group_90->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_91->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLodOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_91->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLodOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_91->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLodOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_91->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler3D),
                         ...
                         ALLOC_PARAM("offset"_sv, &builtin_ivec3))));
    group_91->overloads.push_back(ALLOC_FUNCTION(
      "textureProjLodOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec4),
                         ALLOC_PARAM("lod"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    ...
    group_92->overloads.push_back(ALLOC_FUNCTION(
      "textureGrad"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    group_92->overloads.push_back(ALLOC_FUNCTION(
      "textureGrad"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    group_92->overloads.push_back(ALLOC_FUNCTION(
      "textureGrad"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    ...
    group_92->overloads.push_back(
      ALLOC_FUNCTION("textureGrad"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("dPdx"_sv, &builtin_vec2),
    ...
    group_93->overloads.push_back(ALLOC_FUNCTION(
      "textureGradOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_93->overloads.push_back(ALLOC_FUNCTION(
      "textureGradOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_93->overloads.push_back(ALLOC_FUNCTION(
      "textureGradOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_float),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
    ...
    group_93->overloads.push_back(
      ALLOC_FUNCTION("textureGradOffset"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("dPdx"_sv, &builtin_vec2),
                       ...
                       ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_93->overloads.push_back(ALLOC_FUNCTION(
      "textureGradOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec3),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
    ...
    group_94->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGrad"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    group_94->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGrad"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    group_94->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGrad"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    ...
    group_94->overloads.push_back(
      ALLOC_FUNCTION("textureProjGrad"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec4),
                       ALLOC_PARAM("dPdx"_sv, &builtin_vec2),
                       ALLOC_PARAM("dPdy"_sv, &builtin_vec2))));
    group_94->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGrad"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec4),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float))));
    ...
    group_95->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGradOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_95->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGradOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_int))));
    group_95->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGradOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler1D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
    ...
    group_95->overloads.push_back(
      ALLOC_FUNCTION("textureProjGradOffset"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DRectShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec4),
                       ALLOC_PARAM("dPdx"_sv, &builtin_vec2),
                       ...
                       ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_95->overloads.push_back(ALLOC_FUNCTION(
      "textureProjGradOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler1DShadow),
                         ALLOC_PARAM("P"_sv, &builtin_vec4),
                         ALLOC_PARAM("dPdx"_sv, &builtin_float),
                         ALLOC_PARAM("dPdy"_sv, &builtin_float),
    ...
    group_96->overloads.push_back(ALLOC_FUNCTION(
      "textureGather"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_96->overloads.push_back(ALLOC_FUNCTION(
      "textureGather"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_96->overloads.push_back(ALLOC_FUNCTION(
      "textureGather"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2))));
    group_96->overloads.push_back(ALLOC_FUNCTION(
      "textureGather"_sv, &builtin_vec4,
    ...
    group_96->overloads.push_back(
      ALLOC_FUNCTION("textureGather"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("refZ"_sv, &builtin_float))));
    ...
    group_97->overloads.push_back(ALLOC_FUNCTION(
      "textureGatherOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_sampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_97->overloads.push_back(ALLOC_FUNCTION(
      "textureGatherOffset"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_isampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_97->overloads.push_back(ALLOC_FUNCTION(
      "textureGatherOffset"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("sampler"_sv, &builtin_usampler2D),
                         ALLOC_PARAM("P"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_ivec2))));
    group_97->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_97->overloads.push_back(
      ALLOC_FUNCTION("textureGatherOffset"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(
                       ALLOC_PARAM("sampler"_sv, &builtin_sampler2DArrayShadow),
                       ALLOC_PARAM("P"_sv, &builtin_vec3),
                       ALLOC_PARAM("refZ"_sv, &builtin_float),
        ...
        ALLOC_PARAM("offsets"_sv,
                    VUSH_ALLOCATE(
                      ...
                      VUSH_ALLOCATE(ast::Lt_Integer, allocator,
                                    ast::lt_integer_i32, 4, Source_Info{}))))));
    group_98->overloads.push_back(ALLOC_FUNCTION(
      "textureGatherOffsets"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(
    ...
    group_99->overloads.push_back(
      ALLOC_FUNCTION("atomicAdd"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_99->overloads.push_back(ALLOC_FUNCTION(
      "atomicAdd"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
    ...
    group_100->overloads.push_back(
      ALLOC_FUNCTION("atomicMin"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_100->overloads.push_back(ALLOC_FUNCTION(
      "atomicMin"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_101->overloads.push_back(
      ALLOC_FUNCTION("atomicMax"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_101->overloads.push_back(ALLOC_FUNCTION(
      "atomicMax"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_102->overloads.push_back(
      ALLOC_FUNCTION("atomicAnd"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_102->overloads.push_back(ALLOC_FUNCTION(
      "atomicAnd"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_103->overloads.push_back(
      ALLOC_FUNCTION("atomicOr"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_103->overloads.push_back(ALLOC_FUNCTION(
      "atomicOr"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_104->overloads.push_back(
      ALLOC_FUNCTION("atomicXor"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_104->overloads.push_back(ALLOC_FUNCTION(
      "atomicXor"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_105->overloads.push_back(
      ALLOC_FUNCTION("atomicExchange"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_int),
                                        ALLOC_PARAM("data"_sv, &builtin_int))));
    group_105->overloads.push_back(ALLOC_FUNCTION(
      "atomicExchange"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("mem"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image1D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage1D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage1D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage2D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image3D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage3D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage3D))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_imageCube))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimageCube))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimageCube))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_imageCubeArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimageCubeArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimageCubeArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage2DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image1DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage1DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage1DArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2DMS))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage2DMS))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMS))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2DMSArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage2DMSArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_ivec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_imageBuffer))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimageBuffer))));
    group_107->overloads.push_back(ALLOC_FUNCTION(
      "imageSize"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimageBuffer))));
    ...
    group_109->overloads.push_back(ALLOC_FUNCTION(
      "imageLoad"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2))));
    group_109->overloads.push_back(ALLOC_FUNCTION(
      "imageLoad"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_iimage2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2))));
    group_109->overloads.push_back(ALLOC_FUNCTION(
      "imageLoad"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2))));
    group_109->overloads.push_back(ALLOC_FUNCTION(
      "imageLoad"_sv, &builtin_vec4,
    ...
    group_111->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicAdd"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_111->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_111->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_111->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicAdd"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_111->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_112->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicMin"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_112->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_112->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_112->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicMin"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_112->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_113->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicMax"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_113->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_113->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_113->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicMax"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_113->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_114->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicAnd"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_114->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_114->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_114->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicAnd"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_114->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_115->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicOr"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_115->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_116->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicXor"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_116->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_116->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_116->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicXor"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_116->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_117->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicExchange"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_117->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_117->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_117->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicExchange"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_117->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_117->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    group_117->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicExchange"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
    ...
    group_118->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicCompSwap"_sv, &builtin_uint,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("compare"_sv, &builtin_uint),
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    ...
    group_118->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_uimage2DMSArray),
                         ...
                         ALLOC_PARAM("data"_sv, &builtin_uint))));
    group_118->overloads.push_back(ALLOC_FUNCTION(
      "imageAtomicCompSwap"_sv, &builtin_int,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("image"_sv, &builtin_image2D),
                         ALLOC_PARAM("P"_sv, &builtin_ivec2),
                         ALLOC_PARAM("compare"_sv, &builtin_int),
                         ALLOC_PARAM("data"_sv, &builtin_int))));
    ...
    group_119->overloads.push_back(
      ALLOC_FUNCTION("dFdx"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_119->overloads.push_back(
      ALLOC_FUNCTION("dFdx"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_119->overloads.push_back(
      ALLOC_FUNCTION("dFdx"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_119->overloads.push_back(
      ALLOC_FUNCTION("dFdx"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_120->overloads.push_back(
      ALLOC_FUNCTION("dFdy"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_120->overloads.push_back(
      ALLOC_FUNCTION("dFdy"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_120->overloads.push_back(
      ALLOC_FUNCTION("dFdy"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_120->overloads.push_back(
      ALLOC_FUNCTION("dFdy"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_121->overloads.push_back(
      ALLOC_FUNCTION("dFdxFine"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_121->overloads.push_back(
      ALLOC_FUNCTION("dFdxFine"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_121->overloads.push_back(
      ALLOC_FUNCTION("dFdxFine"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_121->overloads.push_back(
      ALLOC_FUNCTION("dFdxFine"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_122->overloads.push_back(
      ALLOC_FUNCTION("dFdyFine"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_122->overloads.push_back(
      ALLOC_FUNCTION("dFdyFine"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_122->overloads.push_back(
      ALLOC_FUNCTION("dFdyFine"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_122->overloads.push_back(
      ALLOC_FUNCTION("dFdyFine"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_123->overloads.push_back(
      ALLOC_FUNCTION("dFdxCoarse"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_123->overloads.push_back(
      ALLOC_FUNCTION("dFdxCoarse"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_123->overloads.push_back(
      ALLOC_FUNCTION("dFdxCoarse"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_123->overloads.push_back(
      ALLOC_FUNCTION("dFdxCoarse"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_124->overloads.push_back(
      ALLOC_FUNCTION("dFdyCoarse"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_124->overloads.push_back(
      ALLOC_FUNCTION("dFdyCoarse"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_124->overloads.push_back(
      ALLOC_FUNCTION("dFdyCoarse"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_124->overloads.push_back(
      ALLOC_FUNCTION("dFdyCoarse"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_125->overloads.push_back(
      ALLOC_FUNCTION("fwidth"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_125->overloads.push_back(
      ALLOC_FUNCTION("fwidth"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_125->overloads.push_back(
      ALLOC_FUNCTION("fwidth"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_125->overloads.push_back(
      ALLOC_FUNCTION("fwidth"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_126->overloads.push_back(
      ALLOC_FUNCTION("fwidthFine"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_126->overloads.push_back(
      ALLOC_FUNCTION("fwidthFine"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_126->overloads.push_back(
      ALLOC_FUNCTION("fwidthFine"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_126->overloads.push_back(
      ALLOC_FUNCTION("fwidthFine"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_127->overloads.push_back(
      ALLOC_FUNCTION("fwidthCoarse"_sv, &builtin_float,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_float))));
    group_127->overloads.push_back(
      ALLOC_FUNCTION("fwidthCoarse"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec2))));
    group_127->overloads.push_back(
      ALLOC_FUNCTION("fwidthCoarse"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec3))));
    group_127->overloads.push_back(
      ALLOC_FUNCTION("fwidthCoarse"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("p"_sv, &builtin_vec4))));
    ...
    group_128->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtCentroid"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_float))));
    group_128->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtCentroid"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec2))));
    group_128->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtCentroid"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec3))));
    group_128->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtCentroid"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec4))));
    ...
    group_129->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtSample"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_float),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_129->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtSample"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec2),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_129->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtSample"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec3),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_129->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtSample"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec4),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    ...
    group_130->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtOffset"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_float),
                         ALLOC_PARAM("offset"_sv, &builtin_vec2))));
    group_130->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtOffset"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec2),
                         ALLOC_PARAM("offset"_sv, &builtin_vec2))));
    group_130->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtOffset"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec3),
                         ALLOC_PARAM("offset"_sv, &builtin_vec2))));
    group_130->overloads.push_back(ALLOC_FUNCTION(
      "interpolateAtOffset"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("interpolant"_sv, &builtin_vec4),
                         ALLOC_PARAM("offset"_sv, &builtin_vec2))));
    ...
    group_131->overloads.push_back(
      ALLOC_FUNCTION("barrier"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_132->overloads.push_back(
      ALLOC_FUNCTION("memoryBarrier"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_133->overloads.push_back(ALLOC_FUNCTION(
      "memoryBarrierAtomicCounter"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_134->overloads.push_back(ALLOC_FUNCTION(
      "memoryBarrierBuffer"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_135->overloads.push_back(ALLOC_FUNCTION(
      "memoryBarrierShared"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_136->overloads.push_back(ALLOC_FUNCTION(
      "memoryBarrierImage"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_137->overloads.push_back(ALLOC_FUNCTION(
      "groupMemoryBarrier"_sv, &builtin_void, *ALLOC_ARRAY_PARAM()));
    ...
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_subpassInput))));
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_isubpassInput))));
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_usubpassInput))));
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_subpassInputMS),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_ivec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_isubpassInputMS),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    group_138->overloads.push_back(ALLOC_FUNCTION(
      "subpassLoad"_sv, &builtin_uvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("subpass"_sv, &builtin_usubpassInputMS),
                         ALLOC_PARAM("sample"_sv, &builtin_int))));
    ...
    group_139->overloads.push_back(ALLOC_FUNCTION(
      "anyInvocation"_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_bool))));
    ...
    group_140->overloads.push_back(ALLOC_FUNCTION(
      "allInvocations"_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_bool))));
    ...
    group_141->overloads.push_back(ALLOC_FUNCTION(
      "allInvocationsEqual"_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_bool))));
    ...
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_int,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_int),
                                        ALLOC_PARAM("rhs"_sv, &builtin_int))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uint),
                                        ALLOC_PARAM("rhs"_sv, &builtin_uint))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_double,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_double),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_vec2),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_vec3),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_vec4),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_vec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                                        ALLOC_PARAM("rhs"_sv, &builtin_vec2))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                                        ALLOC_PARAM("rhs"_sv, &builtin_vec3))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                                        ALLOC_PARAM("rhs"_sv, &builtin_vec4))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dvec2),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dvec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dvec3),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dvec4),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_double),
    ...
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_ivec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_ivec2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_int))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_ivec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_ivec3),
                                        ALLOC_PARAM("rhs"_sv, &builtin_int))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_ivec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_ivec4),
                                        ALLOC_PARAM("rhs"_sv, &builtin_int))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_uvec2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uvec2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_uint))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_uvec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uvec3),
                                        ALLOC_PARAM("rhs"_sv, &builtin_uint))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_uvec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uvec4),
                                        ALLOC_PARAM("rhs"_sv, &builtin_uint))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_142->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat2x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat2x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat3x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x2),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat3x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat4x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x2),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_mat4x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_float))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_mat2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat2))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_mat3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat3))));
    group_142->overloads.push_back(
      ALLOC_FUNCTION("operator+"_sv, &builtin_mat4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_float),
    ...
    group_142->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat2),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat3),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat4),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat2x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat2x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat2x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat2x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat3x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat3x2),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat3x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat3x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat4x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat4x2),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat4x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_dmat4x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_double))));
    group_142->overloads.push_back(ALLOC_FUNCTION(
      "operator+"_sv, &builtin_dmat2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_double),
    ...
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_float,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_float))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_double,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_double))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_vec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_vec2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_vec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_vec3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_vec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_vec4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dvec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dvec2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dvec3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dvec3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dvec4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dvec4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_ivec2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
    ...
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat2x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat2x3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat2x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat2x4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat3x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat3x2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat3x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat3x4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat4x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat4x2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_mat4x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_mat4x3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat2x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat2x3))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat2x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat2x4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat3x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat3x2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat3x4,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat3x4))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat4x2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat4x2))));
    group_143->overloads.push_back(ALLOC_FUNCTION(
      "operator-"_sv, &builtin_dmat4x3,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("value"_sv, &builtin_dmat4x3))));
    ...
    group_144->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_mat3x2))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat2x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x3),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat3))));
    group_144->overloads.push_back(ALLOC_FUNCTION(
      "operator*"_sv, &builtin_mat2x4,
    ...
    group_144->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_mat4x3))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat2x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat2x4),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat4))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_vec3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_vec2))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat3x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat2))));
    group_144->overloads.push_back(ALLOC_FUNCTION(
      "operator*"_sv, &builtin_mat3,
    ...
    group_144->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x4),
                         ALLOC_PARAM("rhs"_sv, &builtin_mat4x3))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat3x4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat3x4),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat4))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_vec4,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_vec2))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat4x2,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x2),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat2))));
    group_144->overloads.push_back(ALLOC_FUNCTION(
      "operator*"_sv, &builtin_mat4x3,
    ...
    group_144->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x3),
                         ALLOC_PARAM("rhs"_sv, &builtin_mat3x2))));
    group_144->overloads.push_back(
      ALLOC_FUNCTION("operator*"_sv, &builtin_mat4x3,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_mat4x3),
                                        ALLOC_PARAM("rhs"_sv, &builtin_mat3))));
    group_144->overloads.push_back(ALLOC_FUNCTION(
      "operator*"_sv, &builtin_mat4,
    ...
    group_147->overloads.push_back(
      ALLOC_FUNCTION("operator>"_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_int),
                                        ALLOC_PARAM("rhs"_sv, &builtin_int))));
    group_147->overloads.push_back(
      ALLOC_FUNCTION("operator>"_sv, &builtin_bool,
    ...
    group_151->overloads.push_back(
      ALLOC_FUNCTION("operator=="_sv, &builtin_bool,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_bool),
    ...
    group_151->overloads.push_back(ALLOC_FUNCTION(
      "operator=="_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_bvec2),
                         ALLOC_PARAM("rhs"_sv, &builtin_bvec2))));
    group_151->overloads.push_back(ALLOC_FUNCTION(
      "operator=="_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_bvec3),
                         ALLOC_PARAM("rhs"_sv, &builtin_bvec3))));
    group_151->overloads.push_back(ALLOC_FUNCTION(
      "operator=="_sv, &builtin_bool,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_bvec4),
    ...
    group_162->overloads.push_back(
      ALLOC_FUNCTION("operator^"_sv, &builtin_uint,
                     *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uint),
                                        ALLOC_PARAM("rhs"_sv, &builtin_uint))));
    group_162->overloads.push_back(ALLOC_FUNCTION(
      "operator^"_sv, &builtin_ivec2,
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_ivec2),
                         ALLOC_PARAM("rhs"_sv, &builtin_ivec2))));
    group_162->overloads.push_back(
    ...
    group_162->overloads.push_back(ALLOC_FUNCTION(
      ...
      *ALLOC_ARRAY_PARAM(ALLOC_PARAM("lhs"_sv, &builtin_uint),
                         ALLOC_PARAM("rhs"_sv, &builtin_uvec4))));
    groups.emplace("operator^"_sv, group_162);
    return groups;
  }
} // namespace vush
